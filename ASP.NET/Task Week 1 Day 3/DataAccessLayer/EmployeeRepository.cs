...
namespace DataAccessLayer
{
    ...
    {
        public async Task<List<EmployeeDt>> GetEmployees()
        {
            using (EmployeeDbContext dbContext = new EmployeeDbContext() )
            {
                ...
                List<EmployeeDt> domainModels = new List<EmployeeDt>();

                foreach ( var emp in employees )
                {
                    domainModels.Add(new EmployeeDt
                    {
        ...
        public async Task InsertEmployee(EmployeeDt employee)
        {
        ...
        public async Task UpdateEmployee(EmployeeDt employee)
        {
            using (EmployeeDbContext dbContext = new EmployeeDbContext())
            {
        ...
        public async Task<EmployeeDt> GetEmployee(int id)
        {
           ...
           using (EmployeeDbContext dbContext = new EmployeeDbContext())
            {
                ...
                EmployeeDt domainModel = new EmployeeDt
                {
