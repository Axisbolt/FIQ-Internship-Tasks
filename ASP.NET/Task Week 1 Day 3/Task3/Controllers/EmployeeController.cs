...
namespace Task1.Controllers
{
    ...
    public class EmployeeController : ControllerBase
    {
        ...
        [Produces("application/json", Type = typeof(IEnumerable<EmployeeDt>))]
        [Route("get-all")]
        public async Task<ActionResult<IEnumerable<EmployeeDt>>> GetAll()
        {
            try
            {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        [Produces("application/json", Type = typeof(EmployeeDt))]
        [Route("get-employee")]
        public async Task<ActionResult<EmployeeDt>> GetEmployeeById(int id)
        {
            try
            {
        ...
        public async Task<ActionResult> InsertEmployee([FromBody] EmployeeDt employee)
        {
            try
            {
        ...
        public async Task<ActionResult> UpdateEmployee([FromBody] EmployeeDt employee)
        {
            try
            {
