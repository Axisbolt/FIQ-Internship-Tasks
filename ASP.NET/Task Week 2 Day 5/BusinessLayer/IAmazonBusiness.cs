...
namespace BusinessLayer
{
    public interface IAmazonBusiness
    {
        ...
        public Task<Ordercostresponse> GetallOrderssumcountry(string n);

        public Task<List<Orderd>> GetallOrderscountry(string n);

        public Task<List<Orderd>> GetAllOrdersByCreatedDate(DateTime n);

       public Task<List<string>> GetAllUserNames();

        public Task<List<Orderd>> GetAllOrdersByCountryName(List<string> order);
        public Task<List<Ordercostgroup>> GetSumOfOrdersByCountry();
